...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		<h3 class="card-title">List of Incident Types</h3>
	...
	<div class="card-body">
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" style="width: 100%;" id="list">
				<colgroup>
					<col width="5%">
					<col width="15%">
					<col width="20%">
				...
				<tbody style="width: 100%;">
					...
					$i = 1;
						...
						$qry = $conn->query("SELECT * from `incident_list` order by `name` asc ");
