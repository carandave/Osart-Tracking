        ...
        <div class="container-fluid">
			<?php 
				...
				// if(isset($_GET['status'])){
					...
					$qry = "SELECT r.id as resId, r.user_id, r.name, r.m_name, r.l_name, r.gender, r.age, r.address, r.report_datetime, r.incident_id, r.location, u.id, u.type, i.id, i.name as `incident` FROM report_list r INNER JOIN users u ON r.user_id = u.id INNER JOIN incident_list i ON r.incident_id = i.id WHERE r.user_id = '$resId'";
