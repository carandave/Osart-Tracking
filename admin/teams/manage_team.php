...
<div class="container-fluid">
	<form action="" id="team-form">
		...
		<div class="form-group">
			<label for="respondent_type" class="control-label">Station</label>
		...
		<div class="form-group">
			<label for="code" class="control-label">Responder Contact Number</label>
			<input type="text" name="code" id="code" class="form-control form-control-sm rounded-0" value="<?php echo isset($code) ? $code : ''; ?>"  required/>
		</div>
		<div class="form-group">
			<label for="team_leader" class="control-label">Responder Name</label>
