	...
	<div class="card-body">
		<div class="container-fluid">
			...
			<form action="" id="manage-user" enctype="multipart/form-data">	
				...
				<!-- <div class="form-group">
                    <label for="type" class="control-label">Station</label>
                    <select name="type" id="type" class="form-control form-control-sm rounded-0" required>
                    <option value="1" <?php echo isset($meta['type']) && $meta['type'] == 1 ? 'selected' : '' ?>>Station 1</option>
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Station 2</option>
                    </select>
                </div> -->
				...
				<div class="form-group">
					...
					<input type="date" name="age" id="age" class="form-control" value="<?php echo isset($meta['age']) ? $meta['age']: '' ?>" required>
				</div>

				<div class="form-group">
                    <label for="type" class="control-label">Gender</label>
                    <select name="type" id="type" class="form-control form-control-sm rounded-0" required>
                    <option value="1" <?php echo isset($meta['type']) && $meta['type'] == 1 ? 'selected' : '' ?>>Male</option>
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Female</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Responder</option>
                    </select>
                </div>
				<div class="form-group">
					<label for="" class="control-label">Avatar</label>
					<div class="custom-file">
		              <input type="file" class="custom-file-input rounded-circle" id="customFile" name="userfile[]" multiple="" onchange="displayImg(this,$(this))" >
		              <label class="custom-file-label" for="customFile">Choose Photo</label>
		            </div>
				</div>
				<div class="form-group d-flex justify-content-center">
					<img src="<?php echo validate_image(isset($meta['image_dir']) ? $meta['image_dir'] :'') ?>" alt="" id="cimg" class="img-fluid img-thumbnail">
				</div>
			</form>
		</div>
	</div>
